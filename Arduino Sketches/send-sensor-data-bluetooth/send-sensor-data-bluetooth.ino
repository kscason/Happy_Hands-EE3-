...
unsigned contactPin[] = {23, 22, 21, 12, 11, 10, 9, 5, 7, 2}; // Pick digital pins for contacts
...
//  Serial.print(" | GyZ = "); Serial.println(map(GyZ, -32768, 32767, -100, 100));
  ...
  else if (AcX_SCALED <= Downwards_X + OFFSET
    && AcY_SCALED <= Downwards_Y + OFFSET && AcY_SCALED >= Downwards_Y - OFFSET
    && AcZ_SCALED <= Downwards_Z + OFFSET) {
